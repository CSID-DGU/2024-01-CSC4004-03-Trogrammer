...
public class RecipeServiceImpl implements RecipeService{
	...
	@Override
	public List<Map<String, Object>> getRecipe(String rcp_nm) {
		StringBuffer response = null;
		List<Map<String, Object>> list = new ArrayList<>();
		//예외처리
        try {
            String apiURL = "http://openapi.foodsafetykorea.go.kr/api/8ac3e95b730b4d998a2f/COOKRCP01/json/1/5/RCP_NM=" + rcp_nm;
